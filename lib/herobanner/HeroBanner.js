...
var styles = {
  ...
  "three-quarter": "HeroBanner__three-quarter___1wiS4",
...
var HeroBanner = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(HeroBanner, [{
    ...
    value: function render() {
      ...
      var container_classname = classnames(className, styles['container'], styles[text_position === 'top' && 'justify-top'], styles[text_position === 'bottom' && 'justify-bottom'], styles[hero_height === 'full' && 'full'], styles[hero_height === 'three-quarter' && 'three-quarter'], styles[hero_height === 'half' && 'half'], styles[hero_height === 'auto' && 'auto']);
