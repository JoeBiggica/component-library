...
storiesOf('rcom-common-ui/ReutersLogo', module).addDecorator(withKnobs).addDecorator(centered).add('Five rings with gray text (default)', function () {
  return React.createElement(ReutersLogo, {
    title: "Reuters",
