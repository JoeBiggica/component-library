...
storiesOf('component-library/TextLabel', module).addDecorator(centered).addDecorator(withKnobs).add('default', function () {
  ...
  return /*#__PURE__*/React.createElement(TextLabel, _defineProperty({
    text: text('text', example_text),
    font: select('font', TextLabel.Font)
  }, "text", example_text));
