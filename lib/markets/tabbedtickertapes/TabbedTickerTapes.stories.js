...
storiesOf('component-library/markets/TabbedTickerTapes', module).addDecorator(centered).addDecorator(withKnobs({
  escapeHTML: false
})).add('default', function () {
  return /*#__PURE__*/React.createElement(TabbedTickerTapes, {
    style: {
      width: '940px'
    },
    tabs: tabs,
