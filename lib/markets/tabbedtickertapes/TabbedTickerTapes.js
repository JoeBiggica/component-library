...
function (_PureComponent) {
  ...
  function TabbedTickerTapes() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TabbedTickerTapes)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(TabbedTickerTapes, [{
    ...
    value: function render() {
      ...
      })), quotes && React.createElement(TickerTape, {
