...
function (_PureComponent) {
  ...
  function SocialTools() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SocialTools).apply(this, arguments));
  }
    ...
    value: function renderSocialButton(urls, share, color, borderless, platform, index) {
      ...
      switch (platform) {
        case Platform.FACEBOOK:
          return React.createElement(Facebook, _extends({}, props, {
            share: share
          }));

        case Platform.TWITTER:
          return React.createElement(Twitter, _extends({}, props, {
            share: share
          }));
        ...
        case Platform.INSTAGRAM:
          return React.createElement(Instagram, props);

        case Platform.LINKEDIN:
          return React.createElement(LinkedIn, props);

        case Platform.RSS:
          return React.createElement(Rss, props);

        case Platform.EMAIL:
          return React.createElement(Email, _extends({}, props, {
            share: share
          }));
