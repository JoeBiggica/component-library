...
describe('<Image />', function () {
  it('should render Image component correctly', function () {
    var _render = render(React.createElement(Image, commonProps)),
        container = _render.container;

    expect(container).toMatchSnapshot();
  });
  it('should render Image component with amp tag', function () {
    var _render2 = render(React.createElement(Image, _extends({}, commonProps, {
      is_amp: true
    }))),
  ...
  it('should render Image component with aspect_ratio', function () {
    var _render3 = render(React.createElement(Image, _extends({}, commonProps, {
