...
var styles = {
  ...
  "spring-image-container": "Gallery__spring-image-container___EynEH",
  "spring-image": "Gallery__spring-image___3BEGy",
  ...
  function Gallery() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderImage", function (image, index) {
      ...
      var _this$props = _this.props,
          spring = _this$props.spring,
          image_style = _this$props.image_style;
      var lightbox_image = {
        url: url
      };
      ...
      if (spring) {
        ...
        }, /*#__PURE__*/React.createElement(SpringImage, {
